...
Install Python and Jupyter Notebook (see INSTALLATION_en_es.md).

Clone or download this repository.

Open a terminal and start Jupyter Notebook in the repository folder: jupyter notebook
Open the notebooks in the notebooks/ directory and run the cells step by step.

Instala Python y Jupyter Notebook (ver INSTALLATION_en_es.md).
Clona o descarga este repositorio.
Abre una terminal e inicia Jupyter Notebook en la carpeta del repositorio: jupyter notebook
Abre los notebooks de la carpeta notebooks/ y ejecuta las celdas paso a paso.
